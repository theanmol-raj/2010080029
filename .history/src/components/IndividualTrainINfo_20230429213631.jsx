    ...
    <div className=" bg-gradient-to-r flex justify-center items-center from-yellow-500 to-orange-500 h-screen rounded-3xl p-4 m-4">
      <div className=" bg-white p-4 flex flex-col justify-center items-center">
        ...
        <div className=" flex justify-between w-full px-8 py-4">
          ...
          <h1 className=" font-light bg-gray-900">{train.trainNumber}</h1>
        </div>
        <div className=" flex justify-between items-center w-full px-8 py-4">
          <h1 className="text-xl font-mono font-semibold">Availablity</h1>
          <div className=" flex justify-between  py-4">
            <h1 className=" font-light bg-gray-900" >
        ...
        <div className=" flex justify-between w-full px-8 py-4">
          ...
          <h1 className=" font-light bg-gray-900">{train.delayedBy}Hours</h1>
        </div>
      </div>
    </div>
  );
